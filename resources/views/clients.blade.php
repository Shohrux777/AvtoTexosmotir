        ...
        <div class="bg-white">
            ...
            @csrf
                ...
                <div class="row">
                    ...
                    <input type="text" class="form-control" id="codes" name="code" placeholder="">
                    </div>
                    <div class="col-4">
                ...
                <div class="row mt-4">
                    ...
                    <div class="col-3">
                        ...
                        <div>
                            <div class="input-group">
                                <input type="text" class="form-control" name="model" placeholder="Enter model" list="model"  aria-label="Recipient's username" aria-describedby="button-addon2">
                                <datalist id="model">
                                <option value="BMW">
                                <option value="MRS">
                                <option value="Toyota">
                    ...
                    <div class="col-3">
                        ...
                        <input type="text" class="form-control" id="ishlab_chiqarilgan_yili" name="ishlab_sana" placeholder="">
                    </div>
                    <div class="col-3">
                ...
                <div class="row mt-4">
                    <div class="col-3">
                        ...
                        <input class="form-control" name="rangi" list="datalistOptions" id="exampleDataList" placeholder="Type to search...">
                    ...
                    <div class="col-3">
                        ...
                        <input type="text" class="form-control" id="texnik_passport" name="texnik_pass" placeholder="">
                    </div>
                    <div class="col-3">
                        <label for="telefon_nomeri" class="form-label m-0 p-0">Telefon nomeri</label>
                        <input type="tel" max="9" class="form-control" id="telefon_nomeri" name="t_number" placeholder="">
                    </div>
                    <div class="col-3">
                        <label for="texnik_kurik_sana" class="form-label m-0 p-0">Texnik ko'rikdan o'tgan sana</label>
                        <input type="date" class="form-control" id="texnik_kurik_sana" name="tex_otgan_sana" placeholder="">
                    </div>
                    <div class="col-3"></div>
                </div>
                ...
                <div id="spg" class="show mt-5">
                    ...
                    <div class="row  "  >
                        <div class="col-3">
                            ...
                            <input type="text" class="form-control" id="gaz_balon_raqami" name="gaz_raqam" placeholder="">
                        </div>
                        <div class="col-3">
                            <label for="gazbalon_abyom" class="form-label m-0 p-0">Gazbalon abyomi</label>
                            <input type="text" class="form-control" id="gazbalon_abyom" name="gaz_abyom" placeholder="">
                        </div>
                        <div class="col-3">
                            <label for="gazbalon_vazni" class="form-label m-0 p-0">Gazbalon vazni</label>
                            <input type="number" min="1" class="form-control" id="gazbalon_vazni" name="gaz_vazn" placeholder="">
                        </div>
                        <div class="col-3">
                            <label for="gaz_ishlab_chiqarilgan" class="form-label m-0 p-0">Gazbalon ishlab chiqarilgan</label>
                            <input type="date" min="1" class="form-control" id="gaz_ishlab_chiqarilgan" name="gaz_ishlab_chiq" placeholder="">
                        </div>
                        <div class="col-3 mt-3  ">
                            <label for="gaz_oxirgi_sana" class="form-label m-0 p-0">Gazbalon oxirgi sanasi</label>
                            <input type="date" min="1" class="form-control" id="gaz_oxirgi_sana" name="gaz_oxir_sana" placeholder="">
                        </div>
                        <div class="col-3 mt-3">
                            <label for="oxirgi_tekshirov" class="form-label m-0 p-0">Oxirgi tekshirov</label>
                            <input type="date" min="1" class="form-control" id="oxirgi_tekshirov" name="oxirgi_tek" placeholder="">
                        </div>
